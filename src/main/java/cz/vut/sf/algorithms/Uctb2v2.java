...
public class Uctb2v2 extends Uctb2 {
	
	public Uctb2v2(DefaultCtp ctp, Agent agent) {
		super(ctp, agent);
	}

	@Override
	public Result solve() {
		LOG.info("Starting UCTB2v2, total rollouts = " +numberOfIterations);
