...
public class TestData {
	public static ParsedDTO getData(){
    	...
    	fillProbabilityList(adjacencyList, probabilitiesList, 5);
	...
	private static void fillWeightsList(List<List<Double>> weightsList) {
		List<Double> w1 = new ArrayList<Double>(); w1.add(100d); w1.add(1d);
    	...
    	List<Double> w6 = new ArrayList<Double>(); w6.add(10d); w6.add(10d);
